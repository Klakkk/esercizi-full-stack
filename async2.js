...
async function lanciaVeicoloSpaziale(){
  try {
    const a = await caricaModulo("a,b,c");
    console.log("Veicolo spaziale pronto per il lancio!")
  } catch (error) {
    console.log("qui non facciamo come space x, non li facciamo esplodere")
    
  }
}
lanciaVeicoloSpaziale()

// anche qui, ho provato e dopo qualche tentativo ha funzionato, solo non sono sicuro dello svolgimento